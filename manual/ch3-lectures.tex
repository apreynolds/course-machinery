...
\file{differentiation/lectures/1.1-IntroToDerivatives.tex}:
...
\cs{solidboxes} switch selects natural-height boxes -- the right mode when the
...
\begin{manexsource}
\importproblem{../problems/}{find-derivative.tex}
% -> "Example.  Differentiate f(x) = ..."

\importproblem[number={2.1.8}, desc={from APEX}]
  {../problems/}{find-derivative.tex}
