...
% CourseDocument itself loads Typefaces[osf], TitleBlock, Hyperlinks and
...
\part{Workflows}
\input{ch1-quickstart}
\input{ch2-problem-files}
\input{ch3-lectures}
\input{ch4-assessments}
\input{ch5-prose-documents}
\input{ch6-build-and-find}
\input{ch7-overlay-contract}

\part{Reference}\label{part:reference}
\input{ref-assessment}
\input{ref-lecturenotes}
\input{ref-coursedocument}
\input{ref-exercises}
\input{ref-problemmeta}
\input{ref-factmeta}
\input{ref-passagemeta}
\input{ref-courseboxes}
\input{ref-instructornotes}
\input{ref-workspace}
\input{ref-mathstuff}
\input{ref-typefaces}
\input{ref-titleblock-hyperlinks}
\input{ref-textref}
\input{ref-scripts}
\input{ref-knobs}
