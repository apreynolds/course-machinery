...
To start a new problem, copy an existing file: \file{differentiation/problems/}
...
graphs on either side (see \file{mc-matching-graphs.tex} and
\file{mc-matching-phrases.tex} in the demo repo for both orientations). There
are deliberately no drawn answer arrows -- the inline key on the left item is
the answer, and skipping arrows keeps the system TikZ-free.
