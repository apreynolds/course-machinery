...
the course, so name it --- \texttt{find-passages teaching/passages}. With no
...
\begin{manexsource}
$ find-passages --import --from _admin teaching/passages
...
the operand} --- \texttt{pick-passages teaching/passages} --- because a passage
