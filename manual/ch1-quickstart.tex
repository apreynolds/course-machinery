...
course-demo/
  ...
  .course-machinery-local/  machinery for THIS course, shared across files
    textbook.tex            the text layer: what a book names things and
    openstax.tex            where it lives online. The first is the course
                            default; a second file is a second book, chosen
                            per lecture with \usetext
  .latexmkrc                puts both machinery folders on TEXINPUTS
...
(section~\ref{sec:extending}). The copies are identical; creating a new
...
The one course-wide content file is
\file{.course-machinery-local/textbook.tex}, the
