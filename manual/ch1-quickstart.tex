...
course-demo/
  ...
  .textbook/           the text layer: what the course's book
    textbook.tex       names things, and where it lives online
...
noun lectures call an example, and the section-to-URL map behind
\cs{textbookref}. Masters \cs{input} it in the preamble by relative path.
Section~\ref{sec:extending} explains the one-question test for what
belongs there, why it is a folder, and why it is guarded.
