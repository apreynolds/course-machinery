...
\PassageTitle[whylearnmath]{Why Learn Math?}
...
\noindent The optional argument of \cs{PassageTitle} is the passage's
\cs{label}: it names the passage's own idea, so it belongs to the passage
rather than to whichever document imports it.
