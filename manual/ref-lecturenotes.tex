...
\cs{NotesProblemLabelWord} & the noun imported problems render as
  (default \emph{Example}); redefine per course in \file{course-vocab.tex}.
  Routed into \cs{ProblemLabelWord} so a shared vocab file cannot disturb
  Assessment's fixed ``Q''.\\
\end{tabular}
\end{center}
