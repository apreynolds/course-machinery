...
\begin{manexsource}
\solidboxes    % boxes at natural height; workspace and
               % \FreshPage collapse to nothing
\overlayboxes  % back to the default overlay mode
\end{manexsource}

Under \cs{solidboxes} the boxes carry their own height and \emph{all} the
...
The demo midterm keeps \cs{overlayboxes} written out in its preamble even
though it is the default -- a one-line smoke test that the switch pair
round-trips, and a visible declaration of which mode the document is in.
