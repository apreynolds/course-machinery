...
\texttt{-{}-with}: a passage has no injectable keys, since the only option
\cs{importpassage} accepts is \env{level} and that belongs to the importing
document. And because the bank is a sibling submodule rather than a directory of
