...
The demo repo shows the whole arrangement: \file{.course-machinery-local/textbook.tex}
and \file{.course-machinery-local/openstax.tex} side by side, with a lecture built on
each.
