...
call (section~\ref{sec:ref-titling}). Same discipline as ProblemMeta and
...
\cs{CourseRunningHead} (Titling) and keys its \cs{headrule} off its
...
\cs{providecommand}-stubbed empty in Titling, so reading it never
