...
figures), MathStuff and InstructorNotes, plus \file{enumitem} and
\file{tabularray} (the house list and table packages, as in LectureNotes);
deliberately \emph{not} TitleBlock --
...
\texttt{name=} import keys are ignored: an exam owns its numbering and does
