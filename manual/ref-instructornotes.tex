...
The instructor-only content layer. Everything here is gated on
\cs{ifinstructornotes} and \emph{fully gobbled} when off -- a student build
carries no trace. The flag defaults on when \cs{ShowInstructorNotes} is
