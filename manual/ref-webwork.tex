...
A copy kept under \file{opl/Contrib/} mirrors \file{Contrib/};
anything else under \file{opl/} mirrors \file{OpenProblemLibrary/}.
...
\begin{manexsource}
templates/<topic>/opl/Contrib/CCCS/CollegeAlgebra/3.1/x.pg
